...
export const eventTemplates = [
  ...
  {
    id: "event/outside_recruitment_offer",
    kind: "event",
    name: "Outside Recruitment Offer",
    tags: ["event:external", "pressure:loyalty", "pressure:reputation"],
    description: "Another employer is trying to recruit your best operators.",
    category: "departure_warning",
  ...
  },
  {
    ...
    kind: "event",
    name: "Dockside Recruitment Board",
    tags: ["event:external", "pressure:loyalty", "pressure:reputation", "era:porters"],
    description:
      "Other clearance employers have posted recruitment boards near your front door. Their signing bonuses are hard to ignore.",
    category: "departure_warning",
    pressureTags: ["pressure:loyalty", "pressure:reputation"],
    weight: 1,
  },
