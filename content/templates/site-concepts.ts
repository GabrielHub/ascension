...
export const siteConceptTemplates: readonly SiteConceptTemplate[] = [
  ...
  // ── C-rank sites (skyscraper endgame entry) ─────────────────────────────
  {
    siteConceptId: "site/inverted-stock-exchange",
    name: "Inverted Stock Exchange",
    districtPool: ["district/lower-east-side", "district/harlem-substation"],
    worldSpaceLabel: "Exchange Rift — Inverted Trading Floor",
    conceptSummary:
      "A midtown trading floor that has inverted along the gold-glass ceiling. Desks hang in rows from the inverted floor above. Ticker tape streams upward and resolves into commodities that cannot legally exist. The closing bell still sounds at 4:00 but nobody has rung it in years.",
    rankPool: ["c"],
    rankTone: "surreal",
    threatProfileTags: ["threat:hostile", "threat:unstable", "threat:clustered"],
    hazardTags: ["hazard:spatial-distortion", "hazard:falling-debris", "hazard:noise"],
    enemyFamilyIds: ["enemy-family/ticker-phantoms"],
    bossId: "boss/the-market-maker",
    lootThemeLabels: ["Exchange Salvage", "Inverted Currency"],
    visualTheme: {
      accentPalette: "glass",
      fogTreatmentId: "fog/edge-soft",
      markerStyleId: "marker/commercial",
      copyStyleTags: ["tone:vertiginous", "tone:institutional"],
    },
  },
  {
    siteConceptId: "site/recursive-penthouse-spire",
    name: "Recursive Penthouse Spire",
    districtPool: ["district/harlem-substation", "district/lower-east-side"],
    worldSpaceLabel: "Residential Rift — Self-Referencing Tower",
    conceptSummary:
      "A luxury residential tower whose upper floors now reference themselves. The elevator only arrives at floor 47 regardless of which button you press. Each unit is identical. Each unit is occupied. The building does not allow visitors unless they become residents first.",
    rankPool: ["c"],
    rankTone: "surreal",
    threatProfileTags: ["threat:ambush", "threat:hostile", "threat:unstable"],
    hazardTags: ["hazard:spatial-distortion", "hazard:entrapment", "hazard:low-visibility"],
    enemyFamilyIds: ["enemy-family/penthouse-sirens"],
    bossId: "boss/the-concierge-prime",
    lootThemeLabels: ["Penthouse Salvage", "Residence Keys"],
    visualTheme: {
      accentPalette: "glass",
      fogTreatmentId: "fog/edge-soft",
      markerStyleId: "marker/commercial",
      copyStyleTags: ["tone:opulent", "tone:watchful"],
    },
  },
  {
    siteConceptId: "site/midtown-skybridge-rift",
    name: "Midtown Skybridge Rift",
    districtPool: ["district/harlem-substation", "district/bronx-overpass"],
    worldSpaceLabel: "Skybridge Rift — Corridor Between Towers",
    conceptSummary:
      "A glass-walled skybridge connecting two corporate towers that the rift extended into a corridor with no end. The walkway continues for kilometers, the city below keeps repeating the same three blocks, and the maintenance crew from 2018 is still on shift.",
    rankPool: ["c"],
    rankTone: "heightened",
    threatProfileTags: ["threat:mobile", "threat:hostile", "threat:hazard"],
    hazardTags: ["hazard:spatial-distortion", "hazard:falling-debris", "hazard:noise"],
    enemyFamilyIds: ["enemy-family/skybridge-commuters"],
    bossId: "boss/the-foreman-prime",
    lootThemeLabels: ["Skybridge Salvage", "Corridor Fragments"],
    visualTheme: {
      accentPalette: "glass",
      fogTreatmentId: "fog/edge-soft",
      markerStyleId: "marker/commercial",
      copyStyleTags: ["tone:vertical", "tone:corporate"],
    },
  },
  {
    siteConceptId: "site/corrupted-subway-interchange",
    name: "Corrupted Subway Interchange",
    districtPool: ["district/queens-railyard", "district/bronx-overpass"],
    worldSpaceLabel: "Interchange Rift — Unified Transit Hub",
    conceptSummary:
      "A major subway interchange where every line converges onto platforms that loop back into themselves. Trains arrive from nine directions and all of them are express. The PA system calls out station names that were demolished in the sixties. The conductor still takes your ticket.",
    rankPool: ["c"],
    rankTone: "heightened",
    threatProfileTags: ["threat:clustered", "threat:mobile", "threat:ambush"],
    hazardTags: ["hazard:noise", "hazard:low-visibility", "hazard:electrical"],
    enemyFamilyIds: ["enemy-family/interchange-commuters"],
    bossId: "boss/the-stationmaster",
    lootThemeLabels: ["Interchange Salvage", "Express Tokens"],
    visualTheme: {
      accentPalette: "concrete",
      fogTreatmentId: "fog/fluorescent-flicker",
      markerStyleId: "marker/institutional",
      copyStyleTags: ["tone:mechanical", "tone:crowded"],
    },
  },
  {
    siteConceptId: "site/gallery-of-folded-exhibits",
    name: "Gallery Of Folded Exhibits",
    districtPool: ["district/lower-east-side", "district/harlem-substation"],
    worldSpaceLabel: "Museum Rift — Folded Gallery Wing",
    conceptSummary:
      "A museum wing where each exhibit room has been folded into its own geometry. The Egyptian gallery pulls the air sideways. The modern art wing consumes sound. The docent is still on shift — she is legally required to narrate the rooms, whatever they have become.",
    rankPool: ["c"],
    rankTone: "surreal",
    threatProfileTags: ["threat:ambush", "threat:unstable", "threat:hostile"],
    hazardTags: ["hazard:spatial-distortion", "hazard:entrapment", "hazard:low-visibility"],
    enemyFamilyIds: ["enemy-family/gallery-wraiths"],
    bossId: "boss/the-curator-prime",
    lootThemeLabels: ["Gallery Salvage", "Folded Artifacts"],
    visualTheme: {
      accentPalette: "dust",
      fogTreatmentId: "fog/edge-soft",
      markerStyleId: "marker/institutional",
      copyStyleTags: ["tone:curated", "tone:watchful"],
    },
  },
  {
    siteConceptId: "site/vacated-observation-deck",
    name: "Vacated Observation Deck",
    districtPool: ["district/harlem-substation", "district/red-hook-waterfront"],
    worldSpaceLabel: "Skyscraper Rift — Abandoned Upper Deck",
    conceptSummary:
      "The observation deck atop a midtown tower that the rift abandoned. Altitude here is variable. The coin-operated binoculars show rooms below the deck that do not exist in any blueprint. A wedding party is still waiting for the photographer.",
    rankPool: ["c"],
    rankTone: "surreal",
    threatProfileTags: ["threat:hostile", "threat:unstable", "threat:mobile"],
    hazardTags: ["hazard:falling-debris", "hazard:spatial-distortion", "hazard:low-visibility"],
    enemyFamilyIds: ["enemy-family/altitude-haunts"],
    bossId: "boss/the-altitude-keeper",
    lootThemeLabels: ["Altitude Salvage", "Observation Glass"],
    visualTheme: {
      accentPalette: "glass",
      fogTreatmentId: "fog/edge-soft",
      markerStyleId: "marker/commercial",
      copyStyleTags: ["tone:vertical", "tone:opulent"],
    },
  },
];
