...
const HQ_ROOM_SCENE_BINDINGS: ReadonlyArray<{
  buildingId: string;
  templateId: string;
  roomStateId: string;
  slotId: string;
  ...
  },
  {
    ...
    slotId: "slot/lobby",
    floorIndex: 0,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-lobby.svg",
    sceneFootprint: { cols: 12, rows: 8 },
    sceneViewBox: { minX: -120, minY: 0, width: 1040, height: 680 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    ...
    floorIndex: 0,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-reception-desk.svg",
    sceneFootprint: { cols: 4, rows: 5 },
    sceneViewBox: { minX: -70, minY: 0, width: 520, height: 460 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    ...
    slotId: "slot/bullpen",
    floorIndex: 1,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-bullpen.svg",
    sceneFootprint: { cols: 13, rows: 8 },
    sceneViewBox: { minX: -130, minY: 0, width: 1120, height: 700 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    templateId: "room/situation_room:tier_1",
    roomStateId: "room-state/situation_room:1",
    slotId: "slot/situation-room",
    floorIndex: 1,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-situation-room.svg",
    sceneFootprint: { cols: 5, rows: 6 },
    sceneViewBox: { minX: -80, minY: 0, width: 600, height: 460 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    ...
    slotId: "slot/clinic",
    floorIndex: 2,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-clinic.svg",
    sceneFootprint: { cols: 6, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 680, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    ...
    slotId: "slot/dojo",
    floorIndex: 2,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-dojo.svg",
    sceneFootprint: { cols: 6, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 680, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/crew_lounge:1",
    slotId: "slot/lounge",
    floorIndex: 2,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-crew-lounge.svg",
    sceneFootprint: { cols: 4, rows: 6 },
    sceneViewBox: { minX: -70, minY: 0, width: 520, height: 460 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/supply_hall:1",
    slotId: "slot/supply-hall",
    floorIndex: 3,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-supply-hall.svg",
    sceneFootprint: { cols: 8, rows: 8 },
    sceneViewBox: { minX: -100, minY: 0, width: 820, height: 640 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    templateId: "room/fabrication_bay:tier_1",
    roomStateId: "room-state/fabrication_bay:1",
    slotId: "slot/fabrication-bay",
    floorIndex: 3,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-fabrication-bay.svg",
    sceneFootprint: { cols: 7, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 760, height: 640 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    templateId: "room/rooftop_helipad:tier_1",
    roomStateId: "room-state/rooftop_helipad:1",
    slotId: "slot/helipad",
    floorIndex: 4,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-helipad.svg",
    sceneFootprint: { cols: 9, rows: 8 },
    sceneViewBox: { minX: -100, minY: 0, width: 900, height: 660 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    templateId: "room/sky_garden:tier_1",
    roomStateId: "room-state/sky_garden:1",
    slotId: "slot/sky-garden",
    floorIndex: 4,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-sky-garden.svg",
    sceneFootprint: { cols: 7, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 760, height: 640 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    slotId: "slot/club",
    floorIndex: 5,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-club.svg",
    sceneFootprint: { cols: 13, rows: 8 },
    sceneViewBox: { minX: -130, minY: 0, width: 1120, height: 700 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/green_room:1",
    slotId: "slot/green-room",
    floorIndex: 5,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-green-room.svg",
    sceneFootprint: { cols: 5, rows: 6 },
    sceneViewBox: { minX: -80, minY: 0, width: 600, height: 460 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/drill_floor:1",
    slotId: "slot/drill-floor",
    floorIndex: 6,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-drill-floor.svg",
    sceneFootprint: { cols: 6, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 680, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/recon_course:1",
    slotId: "slot/recon-course",
    floorIndex: 6,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-recon-course.svg",
    sceneFootprint: { cols: 5, rows: 8 },
    sceneViewBox: { minX: -80, minY: 0, width: 620, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    buildingId: "building/skyscraper",
    templateId: "room/trauma_bay:tier_1",
    roomStateId: "room-state/trauma_bay:1",
    slotId: "slot/trauma-bay",
    floorIndex: 6,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-trauma-bay.svg",
    sceneFootprint: { cols: 5, rows: 8 },
    sceneViewBox: { minX: -80, minY: 0, width: 620, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/executive_office:1",
    slotId: "slot/executive-office",
    floorIndex: 7,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-executive-office.svg",
    sceneFootprint: { cols: 6, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 680, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/compliance_office:1",
    slotId: "slot/compliance-office",
    floorIndex: 7,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-compliance-office.svg",
    sceneFootprint: { cols: 4, rows: 6 },
    sceneViewBox: { minX: -70, minY: 0, width: 520, height: 460 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/war_room:1",
    slotId: "slot/war-room",
    floorIndex: 7,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-war-room.svg",
    sceneFootprint: { cols: 6, rows: 8 },
    sceneViewBox: { minX: -90, minY: 0, width: 680, height: 620 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/sky_lounge:1",
    slotId: "slot/sky-lounge",
    floorIndex: 8,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-sky-lounge.svg",
    sceneFootprint: { cols: 13, rows: 8 },
    sceneViewBox: { minX: -130, minY: 0, width: 1120, height: 700 },
    sceneOrigin: [200, 100],
  },
  {
    ...
    roomStateId: "room-state/private_cellar:1",
    slotId: "slot/private-cellar",
    floorIndex: 8,
    assetId: "/data/svg-environments/hq/skyscraper/recipes/scene-the-private-cellar.svg",
    sceneFootprint: { cols: 5, rows: 6 },
    sceneViewBox: { minX: -80, minY: 0, width: 600, height: 460 },
    sceneOrigin: [200, 100],
  },
