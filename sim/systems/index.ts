import { applySimCommand, registerEncounterCommandHandler } from "./commands";
...
void Promise.all([import("./encounter-commands"), import("./incident-system")])
  .then(([encounterMod, incidentMod]) => {
