...
export const RAID_TIPS = {
  ...
  revealProgress:
    "How much of the operation objective has been secured. Ordinary jobs close when the objective is contained; boss contracts use this to open the decisive route.",
  ...
  contractWon: "The contract objective has been secured.",
  ...
  routeLocked: "This job is not ready for a boss push yet.",
