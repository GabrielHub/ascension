...
const SVG_TRASH_BAGS: HqSvgPlacementMeta = {
  svgAnchorX: 32,
  svgAnchorY: 44,
  viewBox: [0, 0, 64, 44],
};
...
const BODEGA_EXTERIOR_PLACEMENTS: readonly HqStaticPlacementDef[] = [
  ...
  {
    id: "placement/background-iso-bg-building-tall-10",
    assetId: "background/iso-bg-building-tall",
    assetUrl: bodegaBg("iso-bg-building-tall.svg"),
    kind: "exterior",
    col: -5.5,
  ...
  {
    id: "placement/background-iso-bg-garden-12",
  ...
  {
    id: "placement/background-iso-bg-trash-bags-14",
    assetId: "background/iso-bg-trash-bags",
    assetUrl: bodegaBg("iso-bg-trash-bags.svg"),
    kind: "exterior",
    col: -5,
    row: 2,
    anchorMode: "iso-bottom",
    svgMeta: SVG_TRASH_BAGS,
    width: 64,
    height: 44,
    zIndex: 2,
    opacity: 1,
  ...
  {
    id: "placement/background-iso-bg-back-alley-16",
  ...
  {
    id: "placement/background-iso-bg-building-tall-20",
    assetId: "background/iso-bg-building-tall",
    assetUrl: bodegaBg("iso-bg-building-tall.svg"),
    kind: "exterior",
    col: -13.5,
  ...
  {
    id: "placement/background-iso-bg-garden-22",
    assetId: "background/iso-bg-garden",
    assetUrl: bodegaBg("iso-bg-garden.svg"),
    kind: "exterior",
    col: 20.5,
  ...
  {
    id: "placement/background-iso-bg-mailbox-24",
  ...
  {
    id: "placement/background-iso-bg-hydrant-26",
  ...
  {
    id: "scenery/building-left-copy-1775078541646",
    assetId: "background/iso-bg-tenement-left",
    assetUrl: bodegaBg("iso-bg-tenement-left.svg"),
    kind: "exterior",
    col: 9.5,
  ...
  {
    id: "placement/background-iso-bg-building-tall-2-copy-1775078566182",
    assetId: "background/iso-bg-building-tall",
    assetUrl: bodegaBg("iso-bg-building-tall.svg"),
    kind: "exterior",
    col: 2,
